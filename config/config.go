...
func GetWxAppId() string {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to get GetWxAppId value.")
		return ""
	}
	return instance.Settings.WxAppId
}
...
func GetGlobalGroupOrPrivate() bool {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to GlobalGroupOrPrivate value.")
		return false
	}
	return instance.Settings.GlobalGroupOrPrivate
}
